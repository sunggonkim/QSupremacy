...
ROLE_CURRENT_MARKERS = {
    ...
    "evaluation": {
        ...
        "threshold landscape": "\\subsection{End-to-End Threshold Landscape}",
        "quality sensitivity": "\\subsubsection{Quality Sensitivity}",
        "practical landscape": "\\subsubsection{Practical Application Landscape}",
        "component and baseline": "\\subsection{Component and Baseline Analysis}",
        "weak scaling": "\\subsubsection{Weak Scaling}",
        "strong scaling": "\\subsubsection{Strong Scaling}",
        "advantage frontier": "\\subsection{Advantage Frontier and Bottleneck Analysis}",
