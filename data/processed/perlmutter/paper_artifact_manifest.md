...
| `paper_figures` | All main manuscript plots are generated PDF artifacts and are checked by the evidence audit. | `scripts/generate_paper_figures.py`<br>`paper/figures/*.pdf` | `paper_figures` |
| `submission_package` | The paper package builds to a 12-page anonymous PDF with evidence, readiness, citation, and artifact checks passing. | `paper/main.pdf`<br>`data/processed/perlmutter/paper_evidence_audit.md`<br>`data/processed/perlmutter/submission_readiness_audit.md` | `submission_readiness` |
