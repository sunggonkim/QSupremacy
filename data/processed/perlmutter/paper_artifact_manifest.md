...
| `submission_package` | The paper package builds to an HPCA 2027-style double-blind PDF with the references starting on page 11, evidence/readiness checks passing, and all-author references. | `paper/main.pdf`<br>`data/processed/perlmutter/paper_evidence_audit.md`<br>`data/processed/perlmutter/submission_readiness_audit.md` | `submission_readiness` |
