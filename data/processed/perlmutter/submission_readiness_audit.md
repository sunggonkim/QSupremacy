...
| anonymous_submission | warning | PASS | current manuscript keeps anonymous authors |
| target_template_selected | warning | RISK | current manuscript still uses lightweight article class rather than a target conference template |
