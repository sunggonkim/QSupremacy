...
| paper_figures | Main paper figures exist for performance, scaling, quality, and frontier analysis | PASS | `paper/figures/scaling_summary.pdf`<br>`paper/figures/strong_native_comparison.pdf`<br>`paper/figures/practical_suite_summary.pdf`<br>`paper/figures/digits_required_speedup.pdf`<br>`paper/figures/digits_quality_speedup.pdf` |
