...
| manuscript_claims | Manuscript text contains the canonical evidence-backed numeric claims | PASS | `paper/0.Main.tex`<br>`paper/4.Evaluation.tex`<br>`paper/6.Conclusion.tex` |
