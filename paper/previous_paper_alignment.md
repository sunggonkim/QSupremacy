...
counts, role-marker order, paragraph-role inventory, and current source-line
locations for the manuscript, AURORA-Q, and ScaleQsim.
...
| Paragraph-role audit | `previous_paper_alignment_metrics.md` | Lists the ordered role and current source line of each section block and the previous-paper logic it follows. |
