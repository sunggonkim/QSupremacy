...
counts, role-marker order, and paragraph-role inventory for the current
manuscript, AURORA-Q, and ScaleQsim.
...
| Paragraph-role audit | `previous_paper_alignment_metrics.md` | Lists the ordered role of each current section block and the previous-paper logic it follows. |
