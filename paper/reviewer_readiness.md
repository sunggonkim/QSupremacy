...
| Submission hygiene | The package may contain undefined references, personal paths, or nonanonymous metadata. | The readiness audit checks page count, undefined references, BibTeX warnings, anonymity, TODOs, and artifact documentation. | `data/processed/perlmutter/submission_readiness_audit.md`, `scripts/audit_submission_readiness.py` |
