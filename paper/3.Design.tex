...
\begin{figure}[t]
    ...
    \Description{Block diagram of QAdvantage with shared workload control, native path execution, quantum path execution, measurement logging, and advantage threshold analysis.}
...
This gives a hardware requirement rather than a vague claim of advantage.
