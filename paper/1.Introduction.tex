...
\begin{figure}[t]
    ...
    \begin{subfigure}{0.39\linewidth}
        ...
        \caption{Comparison path.}
        \label{fig:intro-gap-path}
        \Description{Pipeline diagram contrasting native application execution with quantum-circuit application execution.}
    \end{subfigure}
    \begin{subfigure}{0.57\linewidth}
        ...
        \Description{Summary of measured required speedups for controlled and practical workloads.}
    \end{subfigure}
