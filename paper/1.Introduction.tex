...
\begin{figure}[t]
    ...
    \caption{Required speedup for each native/quantum pair. The left side of each label names the native HPC/ML baseline and the right side names the quantum-circuit path.}
    \label{fig:intro-gap}
\end{figure}
