...
\begin{figure}[t]
    \centering
    \includegraphics[width=0.82\linewidth]{figures/intro_threshold_summary.pdf}
    \Description{Summary of measured required speedups for controlled ML circuit methods and practical workload families.}
    \caption{Application-level threshold examples. The key comparison is not simulator versus simulator. The key comparison is native application execution versus quantum-circuit application execution and projected quantum hardware execution. ML is split into controlled QNN/VQC, controlled QKernel, and practical feature-circuit cases; Sim-Ham. denotes Hamiltonian simulation.}
    \label{fig:intro-gap}
\end{figure}
