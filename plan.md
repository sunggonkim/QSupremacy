...
| HPCA body budget | Expanded evidence draft; references start on page 14 |
...
submission readiness: EVIDENCE_READY_WITH_SUBMISSION_RISKS, warning_count 1, references_start_page 14
```
...
This leaves one intentional submission risk: the evidence-rich draft is over the
11-page HPCA body target and must be compressed after the review-response content
stabilizes.
