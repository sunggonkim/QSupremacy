...
| Regular strong-scaling ladder | Paper uses completed 8/16/32/64-node fixed-work `large` jobs 55792240, 55731032, 55731033, and 55731034 with 7,104 `ok` cases each; no strong-scaling point is normalized from a smaller case count |
| Low-GPU direct strong-scaling extension | Submitted full 7,104-case direct fixed-work jobs for 1/4/8/16 GPUs: 55803679, 55803680, 55803681, and 55803682. These fill Figure 6's low-GPU anchors after completion. |
...
| Regular strong-scaling ladder | Completed in `gpu_regular`: 55792240 used 8 nodes / 32 GPUs / 7,104 fixed cases in 48 minutes 14 seconds; 55731032 used 16 nodes / 64 GPUs / 7,104 fixed cases in 28 minutes 33 seconds; 55731033 used 32 nodes / 128 GPUs / 7,104 fixed cases in 15 minutes 54 seconds; 55731034 used 64 nodes / 256 GPUs / 7,104 fixed cases in 6 minutes 58 seconds. All four plotted strong-scaling anchors are direct fixed-work runs. Low-GPU direct fixed-work extension jobs are pending/running for 1 GPU (55803679), 4 GPUs (55803680), 8 GPUs (55803681), and 16 GPUs (55803682). | Completed: `data/processed/perlmutter/practical_suite_direct32_strong_8n_32g_7104_20260711082639_summary.json`, `data/processed/perlmutter/practical_suite_55731032_scale_16n_64g_summary.json`, `data/processed/perlmutter/practical_suite_55731033_scale_32n_128g_summary.json`, `data/processed/perlmutter/practical_suite_55731034_scale_64n_256g_summary.json`; pending tags: `direct1_strong_1g_7104_20260711213724`, `direct4_strong_1n_4g_7104_20260711213724`, `direct8_strong_2n_8g_7104_20260711213724`, `direct16_strong_4n_16g_7104_20260711213724` |
...
| C17 | Low-end scaling visibility | Do not hide smaller GPU-axis context; show full low-to-high GPU labels and label any missing or normalized evidence explicitly. | Reflected in Fig. 5 as a 1--256 GPU weak-scaling ladder. Fig. 6 now has a 1--256 GPU axis and submitted direct fixed-work jobs to fill 1/4/8/16 GPU anchors; completed anchors remain 32/64/128/256 until those jobs finish. |
