...
| C17 | Low-end scaling visibility | Do not hide smaller GPU runs; show them as context when conditions differ and label any normalization explicitly. | Reflected in Fig. 5 as a 1--256 GPU weak-scaling ladder and in Fig. 6 as direct 32/64/128/256 GPU fixed-work anchors with no normalization. |
